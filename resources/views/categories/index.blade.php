                ...
                @foreach($categories as $category)
                    <div class="row py-1">
                        ...
                        <div class="col-md-3 d-flex justify-content-end">
                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modal-{{ $category->id }}">Eliminar
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    ¿Está seguro de querer eliminar la categoria <strong>{{ $category->name }}</strong>?
                                </div>
